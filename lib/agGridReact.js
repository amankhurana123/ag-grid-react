...
var AgGridReact = /** @class */ (function (_super) {
    ...
    AgGridReact.prototype.componentWillReceiveProps = function (nextProps) {
        ...
        AgGrid.ComponentUtil.ALL_PROPERTIES.forEach(function (propKey) {
            ...
            var ab = typeof _this.props[propKey] === 'object' ? JSON.parse(JSON.stringify(_this.props[propKey])) : _this.props[propKey];
            var cd = typeof nextProps[propKey] === 'object' ?  JSON.parse(JSON.stringify(nextProps[propKey])) : nextProps[propKey]
            if (!_this.areEquivalent( ab,cd )) {
                if (debugLogging) {
